...
int main( void )
{
    ...
    GLuint first_triangle_shaders =
        LoadShaders( "SimpleVertexShader.vertexshader", "FirstTriangle.shader" );

    GLuint second_triangle_shaders =
        LoadShaders( "SimpleVertexShader.vertexshader", "SecondTriangle.shader" );


    static const GLfloat first_triangle[] = {
        -0.7f, -0.7f, 0.0f,
        0.5f, -0.5f, 0.0f,
        -0.5f,  0.7f, 0.0f,
        -0.6f, -0.5f, 0.0f,
